...
const FEATURES = {
  ...
  studio_voice:      { tier: 'ritual', name: 'Serenity', page: 'builder',
                       headline: 'Let Serenity read it to you ✦',
                       why: 'A calm, warm AI voice that reads every line for you — for the nights you want the session without recording it yourself.' },
